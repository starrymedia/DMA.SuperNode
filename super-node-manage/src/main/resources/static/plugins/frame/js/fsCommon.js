...
layui.define(['layer', 'form', 'fsConfig', 'fsButtonCommon'], function (exports) {
    ...
    var fsCommon = {
        ...
        errorMsg: function (text) {
            top.layer.msg(text || '操作失败!', {icon: 2, time: 5000});
        },
        /**成功 msg提示 */
        successMsg: function (text) {
            top.layer.msg(text || '操作成功!', {icon: 1, time: 5000});
        },
        /**警告弹出提示*/
        warnMsg: function (text) {
            top.layer.msg(text || '&nbsp;', {icon: 0});
        },
        confirm: function (title, text, fun1,fun2) {
...
//      	 console.error(errorThrown);
        ...
        buttonEvent: function (fsType, getDatagrid) {
            ...
            if (fsType == "tree") {//操作树
                ...
                botton = $("button:not(.fsTree , [lay-filter=ignore])");
            }
